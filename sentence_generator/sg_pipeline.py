...
config_sg = load_config("../config/config_sg.yaml")
...
def run_sg():
    ...
    preset_text = [
        {
            "role": config_sg["sg_LLM"]["preset_text"]["system"]["role"],
            "content": config_sg["sg_LLM"]["preset_text"]["system"]["content"],
        },
        {
            "role": config_sg["sg_LLM"]["preset_text"]["user"]["role"],
            "content": config_sg["sg_LLM"]["preset_text"]["user"]["content"].replace("{original_text}", original_text),
        },
    ]

    request_data = {
        "messages": preset_text,
        "topP": config_sg["sg_LLM"]["request_params"]["topP"],
        "topK": config_sg["sg_LLM"]["request_params"]["topK"],
        "maxTokens": config_sg["sg_LLM"]["request_params"]["maxTokens"],
        "temperature": config_sg["sg_LLM"]["request_params"]["temperature"],
        # "repeatPenalty": config_sg["sg_LLM"]["request_params"]["repeatPenalty"],
        "stopBefore": config_sg["sg_LLM"]["request_params"]["stopBefore"],
        "includeAiFilters": config_sg["sg_LLM"]["request_params"]["includeAiFilters"],
        "seed": config_sg["sg_LLM"]["request_params"]["seed"],
    }
